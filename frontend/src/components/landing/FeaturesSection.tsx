...
function CardUnlock() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-10 md:row-span-2 min-h-[28rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-shadow duration-300"
    >
      {/* Watermark icon */}
