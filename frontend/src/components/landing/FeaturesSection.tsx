...
function CardUnlock() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-10 md:row-span-2 min-h-[28rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300"
    >
      {/* Watermark icon */}
      ...
      <div className="relative z-10">
        ...
        <h3
          className="text-gray-900 text-2xl md:text-3xl font-semibold leading-snug mt-3 max-w-xs"
      ...
      <p className="relative z-10 text-gray-500 text-[15px] leading-relaxed max-w-xs">
...
function CardRealtime() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-10 md:col-span-2 min-h-[14rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300"
    >
      {/* Watermark */}
...
function CardAudit() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-10 min-h-[14rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300"
    >
      <div className="relative z-10">
...
function CardCrossRole() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-[1.5rem] md:rounded-[2rem] p-8 md:p-10 min-h-[14rem] flex flex-col items-center justify-center overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300 text-center gap-4"
    >
...
export function FeaturesSection() {
  return (
    <section id="features" className="w-full max-w-[1536px] mx-auto px-2 sm:px-3 md:px-4 py-4 md:py-8">
      {/* Header row */}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 md:grid-rows-2 gap-3 sm:gap-4">
        <CardUnlock />
        <CardRealtime />
        <CardAudit />
        <CardCrossRole />
