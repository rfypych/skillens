...
function CardUnlock() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-10 md:row-span-2 min-h-[22rem] sm:min-h-[26rem] md:min-h-[28rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300 border border-gray-200/50"
    >
      {/* Watermark icon */}
      ...
      <p className="relative z-10 text-gray-500 text-sm sm:text-[15px] leading-relaxed max-w-xs mt-4 md:mt-0">
...
function CardRealtime() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-10 md:col-span-2 min-h-[12rem] sm:min-h-[14rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300 border border-gray-200/50"
    >
      {/* Watermark */}
      ...
      <p className="relative z-10 text-gray-500 text-sm sm:text-[15px] leading-relaxed max-w-sm mt-3 sm:mt-0">
...
function CardAudit() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-10 min-h-[12rem] sm:min-h-[14rem] flex flex-col justify-between overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300 border border-gray-200/50"
    >
      <div className="relative z-10">
        ...
        >
          Keamanan<br className="hidden sm:inline" /> Tingkat Enterprise.
        </h3>
        <p className="text-gray-500 text-xs sm:text-[15px] mt-2 sm:mt-3 leading-relaxed">
...
function CardCrossRole() {
  return (
    <motion.div
      ...
      className="group relative bg-white rounded-2xl sm:rounded-[2rem] p-6 sm:p-8 md:p-10 min-h-[12rem] sm:min-h-[14rem] flex flex-col items-center justify-center overflow-hidden hover:shadow-[0_8px_30px_rgb(0,0,0,0.06)] transition-shadow duration-300 text-center gap-4 border border-gray-200/50"
    >
...
export function FeaturesSection() {
  return (
    <section id="features" className="w-full max-w-[1720px] mx-auto px-2 sm:px-4 lg:px-6 py-4 sm:py-6 md:py-10">
      {/* Header row */}
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-6 sm:mb-8 gap-4">
        ...
        >
          <Link
            href="/signup"
            className="inline-flex items-center gap-2 text-xs sm:text-sm font-medium text-gray-600 border border-gray-300 px-4 sm:px-5 py-2 sm:py-2.5 rounded-full hover:border-gray-900 hover:text-gray-900 transition-all duration-200 whitespace-nowrap"
          >
            Mulai Evaluasi
      ...
      {/* Card grid */}
      <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-3 sm:gap-4">
        <CardUnlock />
        <CardRealtime />
        <CardAudit />
        <CardCrossRole />
