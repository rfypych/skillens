...
export function CTASection() {
  return (
    <div className="w-full flex items-center justify-center p-2 sm:p-3 md:p-4 pb-0 bg-[#EFEFEF]">
      <section
        className="relative w-full max-w-[1536px] rounded-[1.5rem] md:rounded-[3rem] overflow-hidden flex flex-col items-center justify-center min-h-[380px] sm:min-h-[480px] md:min-h-[560px]"
      >
        ...
        <div className="relative z-10 flex flex-col items-center text-center px-6 gap-6">
          ...
          <motion.h2
            ...
            className="text-white text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold leading-tight max-w-2xl px-4"
