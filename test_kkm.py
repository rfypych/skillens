...
def test_kkm_and_rank():
    ...
    try:
        ...
        for i in range(5):
            ...
            fastapi_app.dependency_overrides[backend.utils.auth.get_current_user] = lambda idx=i: override_get_current_user(idx)
            
            response = client.get("/api/candidates/applications")
